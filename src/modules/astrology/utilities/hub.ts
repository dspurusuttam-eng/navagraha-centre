    ...
    cards: [
      {
        ...
        description: "Ask chart-aware questions with safe guidance continuity.",
        href: "/ai",
        fallbackHref: "/dashboard/ask-my-chart",
        ctaLabel: "Ask AI",
        status: "requires Kundli",
        category: "guidance",
        icon: "ai",
      ...
      },
      {
        ...
        href: "/consultation",
        fallbackHref: "/dashboard/consultations",
...
const utilityShortcutCards: readonly UtilityHubTool[] = [
  ...
  },
  {
    key: "shortcut-ai",
    title: "Ask NAVAGRAHA AI",
    description: "Continue with chart-aware AI.",
    href: "/ai",
    fallbackHref: "/dashboard/ask-my-chart",
    ctaLabel: "Open",
    status: "requires Kundli",
  ...
  if (!input.hasActiveKundli) {
    ...
    if (input.hasDoshaOrYogaFindings) {
      push(
        ...
        },
        {
          ...
          title: "Ask NAVAGRAHA AI",
          description: "Continue into AI with safe context grounding.",
          href: "/ai",
          ctaLabel: "Ask AI",
    ...
    if (input.viewedNumerology) {
      push(
        ...
        },
        {
          ...
          title: "Ask NAVAGRAHA AI",
          description: "Use AI to explain complementary number patterns.",
          href: "/ai",
          ctaLabel: "Ask AI",
    ...
    if (!hasAiContinuation) {
      push({
        key: "recommend-ai",
        title: "Ask NAVAGRAHA AI",
        description: "Move into chart-aware AI continuity.",
        href: "/ai",
        ctaLabel: "Ask AI",
