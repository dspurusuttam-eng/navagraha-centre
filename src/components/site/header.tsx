        ...
        <Container className="flex flex-wrap items-center justify-between gap-2 py-1.5">
          <div className="flex min-w-0 flex-wrap items-center gap-2">
            {topTrustItems.map((item) => (
              <span
                key={item}
                className="inline-flex min-h-8 min-w-0 items-center gap-1.5 rounded-[var(--radius-pill)] border border-[rgba(185,139,70,0.28)] bg-white px-2.5 py-1 text-[0.62rem] tracking-[0.04em] text-[var(--color-ink-strong)]"
              >
                <span
                  aria-hidden="true"
