// Claude Admin Console C2A — POST /api/admin/articles/[id]/archive.
...
export async function POST(_request: Request, { params }: RouteContext) {
  ...
  return articleServiceResponse(
    await transitionArticle(getAdminArticleDeps(), articleActorFromContext(guard.context), id, "ARCHIVE"),
  );
}
