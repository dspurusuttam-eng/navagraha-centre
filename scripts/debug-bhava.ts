...
import { buildBhavaStructureFromContext } from "@/lib/astrology/bhava-engine";
...
async function main() {
        ...
        JSON.stringify(
          {
            ...
            input,
            resolution,
            note: "Resolution failed before bhava generation.",
          },
          null,
          2
        )
  ...
  const output = buildBhavaStructureFromContext(contextToUse);
    ...
    JSON.stringify(
      {
        ...
        whole_sign: output.wholeSignResult,
        cusps: output.cuspResult,
        integrity: output.integrityResult,
      },
      null,
      2
    )
