import { DashboardAIHistoryDetail } from "@/modules/account/components/dashboard-ai-history-detail";
...
export default async function DashboardAIHistoryDetailPage({
  params,
}: Readonly<{
  ...
  return (
    <main className="min-h-screen bg-[#FFFFFF] px-4 py-6 text-[#111111] sm:px-6 lg:px-8" style={dashboardTheme}>
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <DashboardAIHistoryDetail hub={hub} conversationId={conversationId} />
      </div>
    </main>
  );
}
