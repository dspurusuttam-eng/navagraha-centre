...
const premiumProductCatalog: readonly PremiumProductCatalogItem[] = [
  {
    ...
    premiumValue: "Full section depth while limited free access is active.",
    relationshipNote: "Use with Ask NI for deeper career follow-up.",
    publicHref: "/career-report",
    protectedHref: "/dashboard/report",
    ctaLabelPublic: "Get Free Report",
    ctaLabelProtected: "Get Free Report",
  },
  {
    key: "marriage-report",
    ...
    previewValue: "Core compatibility teaser and guided view.",
    premiumValue: "Deeper compatibility reasoning while free access is active.",
    relationshipNote: "Can continue into consultation for nuanced human interpretation.",
    publicHref: "/marriage-compatibility",
    protectedHref: "/dashboard/report",
    ctaLabelPublic: "Start Free Analysis",
    ctaLabelProtected: "Start Free Analysis",
  },
  {
    key: "finance-report",
    ...
    previewValue: "Useful finance preview with clear next steps.",
    premiumValue: "Full finance report depth while free access is active.",
    relationshipNote: "Pair with Ask NI to clarify action priority.",
  ...
  },
  {
    ...
    premiumValue: "Richer section depth and follow-up while free access is active.",
  ...
  },
  {
    ...
    includes: [
      ...
      "Cross-link into report sections",
      "Persistent flow from question to report",
    ],
    previewValue: "Foundational Ask NI support.",
    premiumValue: "Deeper AI interpretation and higher continuity under free access.",
    relationshipNote: "Natural bridge from assistant questions to structured reports.",
    publicHref: "/ai",
    protectedHref: "/dashboard/ask-my-chart",
    ctaLabelPublic: "Ask NI",
    ctaLabelProtected: "Ask NI",
  },
  {
    key: "consultation-guidance",
    title: "Consultation-led Guidance",
    categoryLabel: "Consultation",
    helpsWith: "Human-led nuance when report or AI context needs deeper interpretation.",
    ...
    premiumValue: "Richer preparation through report and AI context first.",
    ...
    ctaLabelPublic: "Book Free Consultation",
    ctaLabelProtected: "Book Free Consultation",
  },
] as const;
