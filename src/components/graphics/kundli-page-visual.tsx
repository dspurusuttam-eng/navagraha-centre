...
export function KundliPageHeroVisual() {
  return (
    ...
    >
      ...
      <div className="relative space-y-4 p-4 sm:space-y-5 sm:p-6 lg:p-7">
        ...
        <div className="relative mx-auto aspect-square w-full max-w-[19.5rem] sm:max-w-[23rem]">
          <div className="absolute inset-[7%] rounded-full border border-black/8" />
          <div className="absolute inset-[15%] rounded-full border border-black/6" />
          <div className="absolute inset-[23%] rounded-full border border-dashed border-[rgba(184,137,67,0.34)]" />
          <div className="absolute inset-[32%] rounded-full border border-black/6" />
          ...
          <GoldZodiacWheel className="absolute left-1/2 top-1/2 h-[80%] w-[80%] -translate-x-1/2 -translate-y-1/2 sm:h-[84%] sm:w-[84%]" />

          <div className="absolute left-1/2 top-1/2 flex h-[32%] w-[32%] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-[rgba(184,137,67,0.26)] bg-white shadow-[0_18px_42px_rgba(17,24,39,0.06)] sm:h-[34%] sm:w-[34%]">
            <div className="text-center">
              <div className="text-[0.58rem] uppercase tracking-[0.16em] text-[color:var(--color-ink-muted)] sm:text-[0.64rem] sm:tracking-[0.22em]">
                12-Planet
              </div>
              <div className="font-[family-name:var(--font-display)] text-[1.15rem] tracking-[0.12em] text-[color:var(--color-ink-strong)] sm:text-[1.35rem] sm:tracking-[0.16em]">
                NC
              </div>
              <div className="text-[0.58rem] uppercase tracking-[0.16em] text-[color:var(--color-ink-muted)] sm:text-[0.64rem] sm:tracking-[0.22em]">
                Intelligence
