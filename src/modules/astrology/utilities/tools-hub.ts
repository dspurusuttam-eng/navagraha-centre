    ...
    cards: [
      {
        ...
        metaLabel: "Intelligence Tool",
        metaTone: "trust",
        href: "/ai",
        fallbackHref: "/ai",
        ctaLabel: "Ask NI",
        status: "available",
        statusLabel: "Intelligence Tool",
        statusTone: "trust",
        filterKey: "ai-ni",
        icon: "ai",
...
export const toolsHubRecommendationBlocks: readonly {
  ...
  },
  {
    ...
    description:
      "Follow the expanding AI-assisted roadmap for Kundli NI, Dasha NI, Transit NI, Panchang NI, Remedy NI, Numerology Intelligence and more.",
    primaryHref: "/ai",
    primaryLabel: "Ask NI",
    secondaryHref: "/tools",
