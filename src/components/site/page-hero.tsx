...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-[color:var(--color-border)] bg-[linear-gradient(180deg,var(--color-base-0)_0%,var(--color-base-1)_100%)]">
      ...
      <Container className="relative grid min-w-0 gap-10 py-[var(--space-14)] sm:py-[var(--space-16)] lg:grid-cols-[minmax(0,1.28fr)_minmax(280px,0.72fr)] lg:items-start">
        <div className="space-y-7">
          <Badge tone="accent">{eyebrow}</Badge>

          <div className="space-y-5">
            <h1
              className="mobile-safe-text max-w-4xl font-[family-name:var(--font-display)] text-[length:var(--font-size-display-lg)] text-[var(--color-ink-strong)] sm:text-[length:var(--font-size-display-xl)]"
              style={{
            ...
            <p className="mobile-safe-text max-w-[42rem] text-[length:var(--font-size-body-lg)] leading-[var(--line-height-copy)] text-[var(--color-ink-body)]">
              {description}
            </p>
          </div>
          ...
          {note ? (
            <p className="mobile-safe-text max-w-2xl text-[length:var(--font-size-body-sm)] leading-[var(--line-height-copy)] text-[var(--color-ink-muted)]">
              {note}
            </p>
          ) : null}
        </div>
