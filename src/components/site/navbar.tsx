  ...
  return (
    <header
      className={cn(
        ...
        isMarketing
          ? "border-[color:var(--color-border)] bg-[rgba(251,248,242,0.95)]"
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div
            className={cn(
              ...
              isMarketing
                ? "border-[color:var(--color-border)] bg-[rgba(255,255,255,0.84)]"
              ...
              {currentSection.navigation.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    isMarketing
                      ? "border-transparent text-[var(--color-ink-muted)] hover:border-[color:var(--color-border)] hover:bg-[var(--color-trust-bg)] hover:text-[var(--color-ink-strong)]"
                    ...
                    isActiveRoute(pathname, item.href) &&
                      (isMarketing
                        ? "border-[color:var(--color-border-strong)] bg-[var(--color-trust-bg)] text-[var(--color-ink-strong)]"
          ...
          <div
            ...
            className={cn(
              ...
              isMarketing
                ? "border-[color:var(--color-border)] bg-[rgba(255,255,255,0.88)]"
                : "border-[color:var(--color-border)] bg-[rgba(255,255,255,0.03)]",
              ...
              {currentSection.navigation.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    isMarketing
                      ? "border-[color:var(--color-border)] text-[var(--color-ink-body)]"
